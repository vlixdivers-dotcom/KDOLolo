...
export default class Presentateur extends Phaser.Physics.Arcade.Sprite {
    ...
    storySpeech = [[
        ...
        { text: "On nous informent", frame: 0 },
    ...
    [
        ...
        { text: "ne se passe pas comme prévu", frame: 2 },
        { text: "Jean Luc Mélenchon", frame: 0 },
        { text: "se serait emparé de la manifestation", frame: 0 },
    ...
    [
        ...
        { text: "Décrit par nos gentils policiers", frame: 2 },
